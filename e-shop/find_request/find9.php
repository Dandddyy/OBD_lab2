...
$html = "<h3>Find a supplier that supplies more than $count products</h3>";
...
$dompdf->render();
$dompdf->addInfo("Find a supplier that supplies more than $count products", "$date.pdf");
